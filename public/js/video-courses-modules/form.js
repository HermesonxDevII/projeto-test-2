        ...
        $('.modules').append(`
            <div class="row mt-8 align-items-end" id="module_${module_id}">
                <div class="col-lg-8 col-md-8 col-sm-12 pe-3">
                    ...
                    <input type="text" class="form-control module" id="module_name_${module_id}" name="modules[${module_id}]" value="${module_name}"
...
function saveModules() {
    if (validateForm()) {
        ...
        showAlertModal("Preencha as informações solicitadas corretamente para prosseguir.");
    }
}
