...
<body>
    @mobile
        <div class="header">
            <img
                class="melis-logo-mobile"
                src="{{ asset('images/logo2-melis@2x.png') }}"
        ...
        <div class="card">
            @desktop
                <div class="blue-card">
                    <div class="d-flex flex-column pl-50">
                        <img
                            class="melis-logo"
                            src="{{ asset('images/logo-melis-branco.png') }}"
                            alt="Logo da Melis Education"
                        />
            ...
            <div id="welcome" class="d-flex flex-column page">
                @if (!$courses)
                    ...
                    <span class="content">
                        Esse é o formulário de pré-inscrição para as
                        ...
                        Ao preencher esse formulário você concorda com os termos de serviço da Melis Education e se compromete em 
                        
                        @desktop
                            <br>
                        @enddesktop

                        ajudar seu filho(a) em casa com todo o suporte e fazer o pagamento da mensalidade na data combinada.
                ...
                @else
                    ...
                    <span class="title mb-29">Seja bem vindo!</span>
                    <span class="content">
                        Esse é o formulário para iniciar o
                        <span
                            class="red
                                @mobile
                                    fs-14 fw-600
                                @endmobile
                            "
                        > Programa de A.E</span>

                        @mobile
                            <span class="fs-14 fw-600"> (Acompanhamento Escolar) 📚 <br><br> </span>
                        @elsemobile
                        ...
                        Ao preencher, você estará concordando com os nossos termos de serviço e assumindo o compromisso de
                        
                        @desktop
                            <br>
                        @enddesktop
                        
                        apoiar seu filho(a) nos estudos em casa.
                ...
                >
                    ...
                    <label for="plan-kokugo">
                        <input
                            ...
                            type="checkbox"
                            value="Kokugo"
                        /> Kokugo (Língua Nacional do Japão: @mobile <br> @endmobile Interpretação de texto)
                    </label>
                    ...
                    <label for="plan-suugaku-revision">
                        <input
                            id="plan-suugaku-revision"
                            type="checkbox"
                            value="Suugaku Revisão 1 e 2"
                        /> Suugaku Revisão 1 e 2 (Preparação @mobile <br> @endmobile do vestibular)
                    </label>
            ...
            >
                ...
                <span
                    class="title
                        ...
                        @endmobile
                    "
                >Informações do responsável - 1</span>
                ...
                <span
                    class="text
                        ...
                        @enddesktop
                    "
                >Todas as perguntas abaixo são para entender melhor a rotina da sua família e ajudar vocês dentro <br> da sua realidade</span>
                ...
                @mobile
                    <span
                        class="guardian-1-warning warning my-20"
                ...
                <div class="btns-wrapper">
                    @desktop
                        <span
                            class="guardian-1-warning warning mr-20"
                            style="visibility: hidden;"
                        >Preenchimento obrigatório</span>
                    @enddesktop
            ...
            <div id="guardian-2" class="d-flex flex-column page" style="display: none;">
                ...
                <span
                    class="title
                        ...
                        @endmobile
                    "
                >Informações do responsável - 2</span>
                ...
                <div id="family-structure" class="form-card">
                    ...
                    <span
                        id="family-structure-structure-warning"
                        class="warning"
                        style="display: none;"
                    >Preenchimento obrigatório</span>
                </div>
                <div id="family-workers" class="form-card">
                    ...
                    <span
                        class="family-workers-warning warning"
                        style="display: none;"
                    >Preenchimento obrigatório</span>
                </div>
                    ...
                    <div class="radio-inputs">
                        <label>
                            <input
                                type="radio"
                                name="workload"
                                value="No momento não estou trabalhando"
                        ...
                        <label>
                            <input
                                type="radio"
                                name="workload"
                                value="Trabalho menos de 6 horas por dia"
                        ...
                        <label>
                            <input
                                type="radio"
                                name="workload" 
                                value="Trabalho 8 horas por dia + hora extra"
                        ...
                        <label>
                            <input
                                type="radio"
                                name="workload"
                                value="Trabalho de yakin (turno noturno)"
                ...
                <div id="speaks-japanese" class="form-card">
                    ...
                    <div class="radio-inputs">
                        ...
                        <label>
                            <input
                                type="radio"
                                name="speaks-japanese"
                                value="Somente Japonês de fabrica"
                    ...
                    <span class="speaks-japanese-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="studies-at-home" class="form-card">

                    <span>
                        Você reserva um tempo do seu dia para sentar ao lado do seu filho(a) para estudar? <span class="red">*</span>
                    </span>
                    ...
                    <span class="studies-at-home-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="will-return-to-home-country" class="form-card">
                    ...
                    <div class="radio-inputs">
                        <label>
                            <input
                                type="radio"
                                name="will-return-to-home-country"
                                value="Sim"
                            /> Sim
                        </label>
                        ...
                        <input id="will-return-to-home-country-other" class="other" type="text" style="display: none;">
                    </div>

                    <span class="will-return-to-home-country-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                    ...
                    <div class="radio-inputs">
                        ...
                        <div class="d-flex flex-column">
                            <label for="comunication-other">
                                <input
                                    class="form-checkbox other-checkbox"
                                    type="checkbox"
                                    id="comunication-other"
                                    value="outro"
                                /> Outro
                            </label>
                        </div>
            ...
            <div id="student" class="d-flex flex-column page" style="display: none;">
                ...
                <div id="student-japan-arrival" class="form-card">
                    ...
                    <span class="student-japan-arrival-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-is-shy" class="form-card">
                    ...
                    <span class="student-is-shy-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>

                <div id="student-time-alone" class="form-card">
                    <span>Quanto tempo seu filho(a) fica em casa sozinho(a) depois que volta da escola? <span class="red">*</span>
                </span>
                    ...
                    <div class="radio-inputs">
                        <label>
                            <input
                                type="radio"
                                name="student-time-alone"
                                value="Não fica em casa sozinho(a)"
                    ...
                    <span class="student-time-alone-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                ...
                <div id="student-rotine" class="form-card">
                    ...
                    <div class="inputs">
                        <label class="small-label mb-25" for="">Explique qual a rotina atual do seu filho(a) nos dias de semana e finais de semana..</label>
                        <textarea name="student-rotine" cols="30" rows="10"></textarea>
                    </div>

                    <span class="student-rotine-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-extra-activities" class="form-card">
                    ...
                    <div class="inputs">
                        <label class="small-label mb-25">Exemplo: Bukatsu de Vôlei, Aula de Judo, Aula de Piano, Aula de Inglês, Juku...</label>
                        <textarea name="student-extra-activities" cols="30" rows="10"></textarea>
                    </div>

                    <span class="student-extra-activities-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-is-focused" class="form-card">
                    ...
                    <span class="student-is-focused-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                ...
                <div id="student-is-organized" class="form-card">
                    ...
                    <span class="student-is-organized-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                ...
                <div id="student-has-good-memory" class="form-card">
                    ...
                    <div class="radio-inputs">
                        ...
                        <input id="student-has-good-memory-other" class="other" type="text" style="display: none;">
                    </div>

                    <span class="student-has-good-memory-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-has-a-study-plan" class="form-card">
                    ...
                    <div class="radio-inputs">
                        ...
                        <input id="student-has-a-study-plan-other" class="other" type="text" style="display: none;">
                    </div>

                    <span class="student-has-a-study-plan-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-review-tests" class="form-card">
                    ...
                    <span class="student-review-tests-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-reads" class="form-card">
                    ...
                    <span class="student-reads-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-studies" class="form-card">
                    ...
                    <span class="student-studies-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-watches-tv" class="form-card">
                    ...
                    <span class="student-watches-tv-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-uses-internet" class="form-card">
                    ...
                    <span class="student-uses-internet-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div id="student-has-smartphone" class="form-card">
                    ...
                    <div class="radio-inputs">
                        ...
                        <input id="student-has-smartphone-other" class="other" type="text" style="display: none;">
                    </div>

                    <span class="student-has-smartphone-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                <div class="btns-wrapper">
            ...
            <div id="final-info" class="d-flex flex-column page" style="display: none;">
                ...
                <div id="student-grades" class="form-card">
                    ...
                    <div class="inputs">
                        <label
                            class="
                                ...
                                @enddesktop
                            "
                        >Selecione a média de notas dos últimos 6 meses</label>
                        ...
                        <div class="inline-radios-separator">
                            <label
                                class="small-label
                                    ...
                                    @enddesktop
                                "
                            > Kokugo: Língua @desktop <br> @enddesktop Nacional do Japão</label>
                        ...
                        <div class="inline-radios-separator">
                            <label
                                class="small-label
                                    ...
                                    @enddesktop
                                "
                            >Shakai: Estudos @desktop <br> @enddesktop Sociais</label>
                        ...
                        <div class="inline-radios-separator">
                            <label
                                class="small-label
                                    ...
                                    @enddesktop
                                ws-nowrap"
                            > Sansuu/Suugaku: @desktop <br> @enddesktop Matemática</label>
                        ...
                        <div class="inline-radios-separator">
                            <label
                                class="small-label
                                    ...
                                    @enddesktop
                                "
                            >Eigo/Gaikokugo: @desktop <br> @enddesktop Inglês</label>
                    ...
                    <span class="student-grades-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                ...
                <div id="student-has-difficult" class="checkboxes form-card">
                    ...
                    <div class="radio-inputs">
                        ...
                        <label for="difficult-in-sansuu">
                            <input
                                id="difficult-in-sansuu"
                                type="checkbox"
                                value="Sansuu/Suugaku"
                            /> Sansuu/Suugaku: Matemática
                        </label>

                        <label for="difficult-in-rika">
                            <input
                                id="difficult-in-rika"
                                type="checkbox"
                                value="Rika"
                            /> Rika: Ciência
                        </label>
                        ...
                        <label for="difficult-in-gaikokugo">
                            <input
                                id="difficult-in-gaikokugo"
                                type="checkbox"
                                value="Gaikokugo/Eigo"
                            /> Gaikokugo/Eigo: Inglês
                        </label>

                        <label for="difficult-in-japanese">
                            <input
                                id="difficult-in-japanese"
                                type="checkbox"
                                value="Japonês"
                        ...
                        <input id="student-has-difficult-other" class="other" type="text" style="display: none;">
                        <input id="student-has-difficult-value" type="hidden">
                    </div>

                    <span class="student-has-difficult-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>

                <div id="student-difficult-in-class" class="form-card">
                    <span>
                        Quais os maiores problemas/dificuldades que seu filho(a) está enfrentando nos estudos da escola japonesa? <span class="red">*</span>
                    </span>

                    <div class="inputs">
                        <label class="small-label mb-25">
                            Escreva uma breve explicação da situação que vocês estão passando e suas preocupações<br>Sua resposta
                        </label>
                        <textarea name="student-difficult-in-class" cols="30" rows="10"></textarea>
                    </div>

                    <span class="student-difficult-in-class-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>

                <div id="student-frequency-in-support-class" class="form-card">
                    <span>
                        Seu filho(a) frequenta alguma sala de apoio na escola japonesa? <span class="red">*</span>
                    </span>
                    ...
                    <div class="radio-inputs">
                        ...
                        <label>
                            <input
                                type="radio"
                                name="student-support-class" value="Sala de Japonês"
                            /> Sala de Japonês
                        </label>
                        ...
                        <label>
                            <input
                                class="other-radio"
                                type="radio"
                                name="student-support-class" value="outro"
                            /> Outro
                        </label>

                        <input id="student-frequency-in-support-class-other" class="other" type="text" style="display: none;">
                    </div>

                    <span class="student-frequency-in-support-class-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                ...
                <div id="student-will-take-entrance-exames" class="form-card">
                    ...
                    <div class="radio-inputs">
                        <label>
                            <input
                                type="radio"
                                name="student-will-take-entrance-exames"
                                value="Sim"
                            /> Sim
                        </label>
                        ...
                        <input id="student-will-take-entrance-exames-other" class="other" type="text" style="display: none;">
                    </div>

                    <span class="student-will-take-entrance-exames-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>
                ...
                <div id="student-has-taken-online-classes" class="form-card">
                    ...
                    <div class="radio-inputs">
                        <label>
                            <input
                                type="radio"
                                name="student-has-taken-online-classes"
                                value="Sim"
                            /> Sim
                        </label>
                        ...
                        <input id="student-has-taken-online-classes-other" class="other" type="text" style="display: none;">
                    </div>

                    <span class="student-has-taken-online-classes-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>

                <div id="guardian-expectations" class="form-card">
                    @if (!$courses)
                        <span>
                            O que precisa acontecer nos estudos do seu filho(a) nos próximos 6 meses para você dizer que valeu a pena investir nas Aulas Semanais da Melis Education? <span class="red">*</span>
                        </span>
                    @else
                        <span>
                            O que precisa acontecer nos estudos do seu filho nos próximos meses para você dizer que valeu a pena investir no Programa de Acompanhamento Escolar? <span class="red">*</span>
                        </span>
                    @endif
                    ...
                    <span class="guardian-expectations-warning warning" style="display: none;">Preenchimento obrigatório</span>
                </div>

                @if ($courses)
                    <div id="guardian-motivations" class="form-card">
                        <span>Por que você decidiu comprar o Programa de Acompanhamento Escolar? <span class="red">*</span></span>

                        <div class="inputs">
                            <textarea name="guardian-motivations" cols="30" rows="10"></textarea>
                        </div>

                        <span class="guardian-motivations-warning warning" style="display: none;">Preenchimento obrigatório</span>
                    </div>
                @endif
                ...
                <div id="guardian-concerns" class="form-card">
                    ...
                    <div class="inputs">
                        <label class="small-label mb-25">
                            Caso tenha acontecido alguma coisa na escola ou tenha alguma preocupação em relação aos estudos do seu<br>filho(a) fique a vontade para compartilhar aqui
                        </label>
            ...
            <div id="thanks" class="d-flex flex-column page" style="display: none;">
                ...
                @else
                    ...
                    <span class="content">
                        Seu link para ter acesso ao Programa de Acompanhamento Escolar será enviado para seu e-mail cadastrado no momento da
                        compra!
                        <br>
                        <br>
        ...
        finalInfoNext.click(function() {
            ...
            if (courses) {
                ...
                var data = {
                    ...
                    'program': 'Acompanhamento Escolar',
                    'program_acronym': 'A.E'
                };
