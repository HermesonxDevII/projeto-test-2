...
@section('content')
    ...
    <div class="w-100 d-flex justify-content-end mt-5 pe-10">
        <button class="btn bg-primary btn-shadow text-white m-1 finish" type="submit" onclick="saveModules()"
