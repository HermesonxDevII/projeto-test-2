...
@section('content')
    <form action="{{ route('evaluations.update', [$classroom->id, $evaluation->id]) }}" method="POST" id="evaluation_form">
        @csrf
        @method('PUT')
        <div style="width: 100%; margin-bottom: 30px; align-items: center;" class="row">
            <div class="col d-flex justify-content-between">
                <h1 style="font-size: 36px; line-height: 48px;" class="p-0 m-0">Editar Avaliação</h1>
            ...
            <div class="card-body">
                <div class="container-fluid p-0">
                    <div class="table-container p-0">
                        @include('evaluations.forms.edit')
                    </div>
                </div>
            </div>
        </div>
