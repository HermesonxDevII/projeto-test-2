<div id="evaluation_tab" class="mt-3">
...
<div class="row my-8">
    <div class="col-lg-4 col-md-4 col-sm-12 pe-3">
        ...
        <input type="text" class="form-control @error('date') is-invalid @enderror" id="date" name="date"
            aria-describedby="date_feedback" placeholder="Insira a data..."
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 pe-3">
        ...
        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title"
            aria-describedby="evaluation_title_feedback" value="{{ old('title', $evaluation->title) }}"
            placeholder="Insira o título..." required>
        @error('title')
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 pe-3">
        ...
        <input type="text" class="form-control @error('content') is-invalid @enderror" id="content" name="content"
            aria-describedby="content_feedback" value="{{ old('content', $evaluation->content) }}"
            placeholder="Insira o conteúdo..." required>
        @error('content')
...
@include('evaluations.table_edit', [
